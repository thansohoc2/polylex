  ...
  return (
    <div className="w-full flex flex-col gap-4">
      ...
      >
        ...
        <p className="text-xs mb-2" style={{ color: textSoft }}>{t('review.listenPrompt')}</p>
        ...
        {grade !== null && (
          ...
          >
            ...
            />
            {translation && <p className="text-sm mt-2" style={{ color: textMuted }}>{translation}</p>}
      ...
      <input
        ...
        autoCapitalize="none"
        spellCheck={false}
        placeholder={t('review.listenPlaceholder')}
