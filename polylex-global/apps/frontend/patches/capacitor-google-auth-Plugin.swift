...
public class GoogleAuth: CAPPlugin, CAPBridgedPlugin {
    ...
    public override func load() {
        guard let clientId = getClientIdValue() else { return }
        let customScopes = getConfigValue("scopes") as? [String] ?? []
    ...
    func signIn(_ call: CAPPluginCall) {
        guard googleSignIn != nil, googleSignInConfiguration != nil else {
